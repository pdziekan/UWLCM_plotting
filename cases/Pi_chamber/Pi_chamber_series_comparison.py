...
#plot_reference_series(Pi_chamber_vars, 0, nplotx, nploty, axarr)
plot_series(Pi_chamber_vars, 0, nplotx, nploty, axarr, xscaledict, yscaledict, xlimdict_series, ylimdict_series, xlabel='Time [h]')
