...
nplots = len(Pi_chamber_vars)# + 2 # 2 updraft profiles without dycoms results
...
plot_profiles(Pi_chamber_vars, 0, nplotx, nploty, axarr, xscaledict, yscaledict, xlimdict_profs, ylimdict_profs, ylabel='z [m]')
